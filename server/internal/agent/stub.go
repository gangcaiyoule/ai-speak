...
func (StubService) CreateThread(context.Context, string) (Thread, error) {
	return Thread{}, errNotImplemented
}

// GetThread 返回“未实现”占位错误。
func (StubService) GetThread(context.Context, string) (Thread, error) {
	return Thread{}, errNotImplemented
}

// ListThreads 返回“未实现”占位错误。
func (StubService) ListThreads(context.Context, string) ([]Thread, error) {
	return nil, errNotImplemented
}

// AppendMessage 返回“未实现”占位错误。
func (StubService) AppendMessage(context.Context, Message) (Message, error) {
...
func (StubTextGenerator) Generate(context.Context, GenerationRequest) (GenerationResponse, error) {
	return GenerationResponse{}, errNotImplemented
}
